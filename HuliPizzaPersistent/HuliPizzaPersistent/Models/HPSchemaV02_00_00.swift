...
enum HPSchemaV02_00_00:VersionedSchema {
  ...
  class OrderItem:Identifiable{
    ...
    var size:PizzaSize
    var quantity:Double
    var dateStamp: Date = Date(timeIntervalSince1970: 0) /* migration will use this where date is empty */
