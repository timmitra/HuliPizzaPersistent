...
typealias OrderTicket = HPSchemaV02_00_00.OrderTicket
typealias OrderItem = HPSchemaV02_00_00.OrderItem
typealias NameModel = HPSchemaV02_00_00.NameModel
typealias RatingModel = HPSchemaV02_00_00.RatingModel

var modelContainer: ModelContainer {
  // add a schema
//  let schema = Schema([OrderTicket.self, NameModel.self, RatingModel.self, OrderItem.self])
  let schema = Schema(versionedSchema: HPSchemaV02_00_00.self)
